...
(aruDOC_coefs_GLM <- coef(ARUmod_gammaBest_red)) #GLM coefs - will be using these, but LM included anyways
(aruDOC_coefs_LM <- coef(aruVars_finalMod_red)) #LM coefs
...
pDOCcomp <- ggplot(compDat_GLM, aes(x=estDOC,y=DOC)) +
